  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-6 mb-5">
        ...
        {/* Preset grid: 1 upload + 5 presets */}
      ...
      {/* Public info fields */}
      <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-6 space-y-5 mb-5">
        {[["นามแฝง","w-14","w-64"],["คำอธิบายตัวตน","w-24","w-52"]].map(([,lw,fw],i) => (
          <div key={i}>
            <div className={`skeleton h-3.5 ${lw} rounded mb-1`} />
            <div className={`skeleton h-3 ${fw} rounded mb-2`} />
            {i === 1
